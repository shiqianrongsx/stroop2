<?php
	  ...
	  if($_REQUEST['submitForm']){
		  	$error=false;
			$_SESSION['studentname'] ="stroopc".htmlspecialchars($_REQUEST['info4'],ENT_QUOTES);
			$result=executeQuery("select name from stroop2 where name ='".$_SESSION['studentname']."';");
			$r=mysql_fetch_array($result);
			if(is_null($r['name'])){
				$query="insert stroop2 (name) value('".$_SESSION['studentname']."');";
